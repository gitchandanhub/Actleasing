	     ...
	     @BeforeTest
	      public void Initialize() throws Exception {
	    	 DateTimeFormatter dtf = DateTimeFormatter.ofPattern("yyyy/MM/dd HH:mm:ss");  
	    	  ...
	    	  htmlreporter = new ExtentHtmlReporter("C:\\Chandan Software\\Neon_workspace\\ABCTest\\ExtentReport\\ACTleasingresult.html");
	    	  ...
	    	  FileInputStream fis = new FileInputStream("C:\\Chandan Software\\Neon_workspace\\ABCTest\\src\\test\\java\\Property\\config.properties");
	    	  config.load(fis);
