...
public class CreatemultiplequoteforIndependentvehicle extends AppDriver
{
	public CreatemultiplequoteforIndependentvehicle()
	{
	...
	@FindBy(xpath = "//*[@id=\"form-select-quotation\"]/h5[4]/input") 
...
//Customer Data
	...
	//Vehicle Data 2
		...
		//Rates
		 ...
		 @FindBy(id= "notes")  WebElement Cusomternotes;
